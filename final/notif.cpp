...
/*notif::notif(QWidget *parent):QWidget(parent)
{
    ...
    connect(&animation, &QAbstractAnimation::finished, this, &notif::hide);
    ...
    timer = new QTimer();
    connect(timer, &QTimer::timeout, this, &notif::hideAnimation);
}
void notif::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event)
...
void notif::setPopupText(const QString &text)
{
...
void notif::setPopupOpacity(float opacity)
{
...
float notif::getPopupOpacity() const
{
    return popupOpacity;
}
*/
