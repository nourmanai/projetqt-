...
salaire::salaire(int id_salaire,QDateTime date_versement, QDateTime date_modification,float montant_salaire ,int sanction,int promotion ,QString nom_personnel)
{
...
return    query.exec();
  ...
  QSqlQueryModel * salaire::recherche_salaire(QSqlQuery query)
  {
           QSqlQueryModel *model = new QSqlQueryModel();
              ...
              //query.prepare("select * from SALAIRE where NOM_PERSONNEL= '"+nom+"' ");
